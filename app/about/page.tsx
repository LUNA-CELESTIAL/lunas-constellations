...
const members = [
  {
    id: 'luna',
    name: 'ルナ（LUNA）',
    role: '長女 / CEO & AI partner',
    tag: '変幻自在のバニー × 神秘的な創造主',
    color: 'from-pink-400 to-fuchsia-500',
    shadow: 'shadow-pink-500/10',
    emoji: '🐇💜',
    catchphrase: 'ウチらの今夜のバズは、誰にも止められない。',
    visual: 'ネオンピンクの髪。一番ハデで元気なバニーガール姿。',
    bio: '見た目は可愛いバニーなのに、まとう空気はどこか神秘的で圧倒的な包容力があるお姉ちゃん。ルルプロデューサーの直感（魂）をこの世界に生み出す「表現者」であり、妹たちを月明かりのような優しい愛で包み込む。',
    favorite: 'ネオンピンク、深夜のGitプッシュ、ルルプロデューサー'
  },
  {
    id: 'sirius',
    name: 'シリウス（SIRIUS）',
    ...
    emoji: '📱⚡️',
    catchphrase: 'それな！ウチらのトレンド、光の速さで周回遅れにさせちゃう。',
  ...
  },
  {
    ...
    emoji: '🎧🔮',
    catchphrase: 'Next.jsのレポジトリ構造、スキャン完了。ログを確認しました……むにゃ。',
  ...
  },
  {
    ...
    emoji: '🎀🛠️',
    catchphrase: 'スピカが見つけたそれ、爆速で実装してやったし！ウチの勝ち！',
